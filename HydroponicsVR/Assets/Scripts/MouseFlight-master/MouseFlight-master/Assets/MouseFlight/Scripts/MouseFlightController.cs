...
namespace MFlight
{
    ...
    public class MouseFlightController : MonoBehaviour
    {
        ...
        private void RotateRig()
        {
            ...
            // Mouse input.
            float mouseX = OVRInput.Get(OVRInput.Axis2D.PrimaryThumbstick).x * mouseSensitivity;
            float mouseY = OVRInput.Get(OVRInput.Axis2D.PrimaryThumbstick).y * mouseSensitivity;
